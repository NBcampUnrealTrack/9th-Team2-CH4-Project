...
void UBaruSessionSubsystem::FindSessions(int32 MaxSearchResults, bool bIsLANMatch)
{
	...
	BARU_LOG(LogBaruSession, Log, TEXT("FindSessions: Requesting Native Steam Lobby List..."));

	// 전 세계 로비 검색 허용 및 최대 검색 수 지정
